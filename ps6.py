...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in lowerCaseList:
            shiftDict[letter] = lowerCaseList[(lowerCaseList.index(letter) + shift) % 26]

        for letter in upperCaseList:
            shiftDict[letter] = upperCaseList[(upperCaseList.index(letter) + shift) % 26]
    ...
    def apply_shift(self, shift):
        ...
        for character in self.message_text:
            if character in string.ascii_lowercase or character in string.ascii_uppercase:
                resultString += shiftDict[character]
            else:
